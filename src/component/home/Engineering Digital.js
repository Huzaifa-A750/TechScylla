  ...
  return (
    <div className="container mx-auto mt-10 md:mt-0 grid xl:flex justify-center lg:pb-32 pb-10">
      ...
      <div className="grid items-center justify-center mt-12 xl:mt-0">
        <div className="bg-[#303030] pb-[22px] rounded-[30px] px-6 pt-[41px] grid justify-center min-h-[280px] w-auto sm:w-[500px] md:w-[700px] xl:w-[390px] text-center">
          ...
          <div className="mt-5">
            <form className="gap-y-8 grid max-w-[500px] xl:max-w-0">
              ...
              <input
                type="text"
                placeholder="Name"
                className="font-[Poppins] font-light bg-inherit border-b-[1px] border-solid sm:w-[340px] placeholder:text-white px-2 text-white focus:outline-none"
              />
              {/* Text-Area */}
              <textarea
                name="Content"
                placeholder="Content"
                cols="30"
                className="font-[Poppins] font-light bg-inherit border-b-[1px] border-solid sm:w-[340px] placeholder:text-white px-2 text-white h-[140px] resize-none focus:outline-none"
              ></textarea>
              {/* Checkbox */}
